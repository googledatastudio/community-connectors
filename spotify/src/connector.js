...
var getOAuthService = function() {
  return OAuth2.createService('Spotify')
    .setAuthorizationBaseUrl('https://accounts.spotify.com/authorize?response_type=code')
    .setTokenUrl('https://accounts.spotify.com/api/token')
    .setClientId('b475f97956fe4b6bb66cfe0a239254a9')
    .setClientSecret('2276d1ebe3fa49a8b48c20598d11ecae')
...
function getSchema(request) {
  var reqSchema = { schema: spotifySchema };
  return reqSchema;
}
