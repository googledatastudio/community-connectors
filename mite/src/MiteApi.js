...
function miteGet(domain, api_key, api, params) {
  ...
  var userAgent = 'Mite Connector for Google Datastudio v{0}; user: {1}; credentials: {2}; The unbelievable Machine Company GmbH'.format(AGENT_VERSION, activeUser, scriptUser);
