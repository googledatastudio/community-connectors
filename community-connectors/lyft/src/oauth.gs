...
function getOAuthService() {
    ...
    return OAuth2.createService('lyftCommunityConnector')
        .setAuthorizationBaseUrl('https://api.lyft.com/oauth/authorize')
        .setTokenUrl('https://api.lyft.com/oauth/token')
        .setClientId(clientId)
        .setClientSecret(clientSecret)
        .setPropertyStore(PropertiesService.getUserProperties())
        .setScope('public rides.read')
